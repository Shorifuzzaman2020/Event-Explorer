...
//               <Link to="/myevent" className="block hover:underline">My Events</Link>
//               {user ? (
//                 <button
//                   onClick={handleLogout}
    ...
    <div className="relative">
      <nav className="bg-blue-600 text-white p-4 flex items-center justify-between">
        ...
        <div className="hidden lg:flex space-x-4">
          ...
          <Link
            to="/myevent"
            className={`${isActive("/myevent") ? "text-yellow-300 font-semibold" : "hover:underline"}`}
          >
            My Events
          </Link>
        </div>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden absolute top-16 left-0 w-full bg-blue-600 text-white p-4 z-50 shadow-lg">
            <div className="space-y-4">
              ...
              <Link
                to="/profile"
                className={`${isActive("/profile") ? "text-yellow-300 font-semibold" : "hover:underline"} block`}
              >
                My Profile
              </Link>
              <Link
                to="/myevent"
                className={`${isActive("/myevent") ? "text-yellow-300 font-semibold" : "hover:underline"} block`}
              >
                My Events
              </Link>
              {user ? (
